<footer class="footer">
  <section class="footer-container">
    <div class="footer-content">
      <div class="column">
        <h2 class="column-title">MVHypnose.reiki</h2>
        <ul class="footer-list">
          <li class="footer-list__item">
            <img src="<?= esc_url(get_parent_theme_file_uri() . '/icons/phone-white.svg'); ?>" alt="phone" />
            <a href="tel:+33759777372">+33759777372</a>
          </li>
          <li class="footer-list__item">
            <img src="<?= esc_url(get_parent_theme_file_uri() . '/icons/mail-white.svg'); ?>" alt="phone" />
            <a href="mailto:mvhypnose.reiki@gmail.com">mvhypnose.reiki@gmail.com</a>
          </li>
        </ul>
      </div>
      <div class="column">
        <h2 class="column-subtitle">Prévention</h2>
        <p class="column-paragraph">
          Ne se substitue à aucun avis et/ou traitement médical.
          En cas de traitement en cours, veuillez poursuivre ce dernier.
        </p>
      </div>
